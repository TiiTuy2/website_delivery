        ...
        @method('PUT')
         ...
         <div class="row">
                <div class="flex flex-wrap mb-5">
                    ...
                    <input class="w-full outline-none p-2 text-green-600 " type="text" name="title" value="{{ $about->title }}" class="form-control" placeholder="ចំណងជើង">
                </div>
                <div class="flex flex-wrap mb-5">
                    <strong class="text-white mb-2">ខ្លឹមសារ</strong>
                    <textarea class="w-full p-2 outline-none text-green-600" class="form-control" style="height:150px" name="content" placeholder="ខ្លឹមសារ">{{ $about->content }}</textarea>
                </div>
                <div class="flex gap-5 mb-5 items-center text-white">
                    ...
                    <img class="border-2 p-2" src="/images/{{ $about->image }}" width="100px">
                </div>
