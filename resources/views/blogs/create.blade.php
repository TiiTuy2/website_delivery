...
<div class="row">
        <div class="mb-5">
            <h2 class="mb-5 text-white text-3xl">បន្ថែមប្លក់ថ្មី</h2>
        </div>
...
<form class="border-2 lg:w-1/2 md:w-1/2 sm:w-1/2 w-full h-auto p-5 bg-green-600  hover:bg-red-600 duration-500" action="{{ route('blogs.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
