...
<div class="row">
        <div class="mb-5">
            <h2 class="mb-5 text-white text-3xl">បន្ថែមទំនេញថ្មី</h2>
        </div>
...
<form class="border-2 lg:w-1/2 md:w-1/2 sm:w-1/2 w-full h-auto p-5 bg-green-600  hover:bg-red-600 duration-500" action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
    @csrf

     <div class="row">
            <div class="flex flex-wrap lg:gap-2 gap-2 mb-2 items-center lg:mb-5">
                <strong class="text-white">ឈ្មោះទំនេញ</strong>
            ...
            <div class="flex flex-wrap lg:gap-2 gap-2 mb-5 items-center">
                ...
                <textarea class="form-control w-full placeholder:text-green-600 border-2 outline-none p-2 text-green-600" style="height:150px" name="detail" placeholder="ពត៍មានលម្អិត"></textarea>
            </div>
            <div class="flex flex-wrap items-center lg:gap-10 gap-2 mb-5">
                <strong class="text-white">រូបភាព</strong>
                <input class="text-white" type="file" name="image" class="form-control" placeholder="image">
            </div>
