        ...
        @method('PUT')
         ...
         <div class="row">
                <div class="flex flex-wrap mb-5">
                    <strong class="text-white mb-2">ឈ្មោះទំនេញ</strong>
                    <input class="w-full outline-none p-2 text-green-600 " type="text" name="name" value="{{ $product->name }}" class="form-control" placeholder="Name">
                </div>
                <div class="flex flex-wrap mb-5">
                    <strong class="text-white mb-2">ពត៍មានលម្អិត</strong>
                    <textarea  class="w-full p-2 outline-none text-green-600" class="form-control" style="height:150px" name="detail" placeholder="Detail">{{ $product->detail }}</textarea>
                </div>
                <div class="flex gap-5 mb-5 items-center text-white">
                    <strong class="text-white"> រូបភាព</strong>
                    <input type="file" name="image" class="form-control" placeholder="image">
                    <img class="border-2 p-2" src="/images/{{ $product->image }}" width="100px">
                </div>
